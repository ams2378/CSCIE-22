...
public class SortCountExp {
   ...
   /**
     ...
     */
    public static void printStats(int length) {
        int spaces;
    ...
    public static void main(String args[]) {
        ...
        */  
        ...
        //int [] asave2 = {20, 7, 14, 18, 2, 30, 6, 23, 11, 5};
        /*
        ...
        */
        ...
        int[] numItemsArr = {1000, 2000, 4000, 8000, 16000, 32000, 64000, 128000};
        
        int i=0, j=0;
        while (j<4) {
            i=0;
            a = randomArray(numItemsArr[j]);
            quickSort(a);
            asave = new int[numItemsArr[j]];
            System.arraycopy(a, 0, asave, 0, a.length);
            while (i<10) {
